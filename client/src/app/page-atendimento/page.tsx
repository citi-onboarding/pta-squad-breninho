...
const PageAtendimento = () => {
  ...
  if (loading) return <p className="text-center text-lg mt-10">Carregando consultas...</p>;
          ...
          <div className="flex flex-row h-[56px] w-[300px] gap-[16px]">
            ...
            <div className="relative w-[144px]">
              ...
              <Image
                ...
                className="absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer w-[20px] h-[20px] object-contain"
              />
            </div>
